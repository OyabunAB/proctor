...
public class AsciiUtil {
    ...
    public static String generateAsciiArtText(final String content) {
        ...
        g.setFont(new Font(fontFamilyNames[ new Random().nextInt(fontFamilyNames.length - 1) ],
                           Font.BOLD,
                           FONT_SIZE));
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                rowBuilder.append(image.getRGB(x,
                                               y) == ALL_COLORS ?
                                  EMPTY_CHARACTER :
                                  FILL_CHARACTER);
            ...
            final String row = StringUtils.stripEnd(rowBuilder.toString(),
                                                    null);
